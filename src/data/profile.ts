// Global identity + links. Fill in the TODOs and the whole site updates.
...
export const profile = {
  ...
  // Used by the footer "built from <hash>" easter egg to link to the commit.
  repoUrl: 'https://github.com/ChrisJTab/christiantabbah.com' as string | null,
}
